...
pro rotationcurvenew,velfile,xc,yc,bestguess_angle,pixelscale,metalmap,metalmaperr,name
...
metalerrcube = readfits(metalmaperr,header)
metalgradientnew,metalcube,metalerrcube,xmid,ymid,x,y,n_slits/2.,slit_size,slitwidth,radius_N2,N2,N2_err,fitparam

fileout = '/scr2/nichal/workspace/output/rotationcurve/'+strmid(velfile,pos1,pos2-pos1)+'_metalN2.png'
pmetal = errorplot(radius_N2,N2,N2_err,xtitle='radius from center(kpc)',ytitle='NII/Ha',symbol='diamond',title=name,sym_color='blue',sym_filled=1,errorbar_color='blue',linestyle=6,thick=2,font_size=20,position=[0.2,0.15,0.95,0.9])
fineradius = findgen(100)/100.*max(radius_N2)
...
pmetal.save,'/scr2/nichal/workspace/output/rotationcurve/'+name+'_metalgradnew.png'
stop
pmetal.close
