im=fitsread('cswa128_SDSSJ1956+5950_deflections.fits');
srcx=im(:,:,2);
srcy=im(:,:,3)  ;
...
fitswrite(flipud(magnification_ALL),'cswa128_magnification.fits');
imref=fitsread('/scr2/nichal/workspace/output/cswa128_Ha_tlc_Kn2_handmosaic_sky_130hr_acube.fits');
detection=imref(:,:,5);
detection=flipud(detection);
%detection = detection(:,1:30);
%magnification_ALL = magnification_ALL(:,1:30);
figure(1)
