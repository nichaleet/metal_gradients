function Dist = ad_dist(Z_vecA,H_0,Omega_0,Lambda_0);
%-------------------------------------------------------------
% This function must have 'chiint' function in same directory!!!
...
for J=1:1:SizeZ(1),
   ...
   %global ChiInt
   %ChiInt = inline('1./sqrt(Omega_0.*(1+Z).^3 +
%(1-Omega_0-Lambda_0).*(1+Z).^2+Lambda_0)','Z','Omega_0','Lambda_0');
