...
outputdir='/scr2/nichal/workspace/paperplots/cswa15/10sigma'   
...
;kinematic
fitstoeps,'sourcekinematic_pretty_corrected.fits',0.422,'kpc','cswa15','velocity(km/s)',outputdir,format='(I0)'
;dispersion
