...
For ii=0,step_annuli do begin
   ...
   if n_elements(goodpix) gt 1. then begin
      ...
      newerr = abs(0.434*val_radius_err_pixel(goodpix)/val_radius_pixel(goodpix))
      ...
      meanerr,val_radius_pixel(goodpix),newerr,wmean,sigmam,sigmad  ;weight mean in log scale
