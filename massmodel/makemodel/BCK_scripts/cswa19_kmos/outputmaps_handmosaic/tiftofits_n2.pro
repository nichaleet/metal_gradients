pro tiftofits_n2,fileref

sourcetiffiles= ['sourceBayesianmetal_err.tif','sourceBayesianmetal.tif','sourceha_detection.tif','sourceha.tif','sourceha_psf.tif','sourcen2index_err.tif','sourcen2index.tif','sourceN2metal_tag.tif','sourcenii.tif','sourcecontinuum.tif','sourcekinematic_err.tif','sourcekinematic.tif','sourceveldisp_err.tif','sourceveldisp.tif']
