pro macs1133_model, image,hdr,pixsize,newimage,newheader,newscale
...
; into account.
readcol, 'MACS1133_source.dat',ids,xsource,ysource ;(id, RA,Dec)
readcol, 'MACS1133_Osiris.mul',idi,xsky,ysky
...
remove,outfield,x,y,ids,xsource,ysource,idi,xsky,ysky
