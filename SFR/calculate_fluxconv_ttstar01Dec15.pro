pro calculate_fluxconv_ttstar,filestarcubes,name=name,cluster=cluster,filters=filters,photmags=mags,mags_err=mags_err,z=z,linewl=linewl,outthres=outthres,calibfactors=output,fixpeak=fixpeak,fixcenter=fixcenter,centerpos=centerpos,usepipeline=usepipeline,floor=floor,stoptag=stoptag
;Explanation:
...
output = replicate({filestarcube:'',filter:'',starname:'',clustername:'',mag:0.,z:0.,linewl:0.,conv_factor:0.,conv_factorerr:0.,unitto:'erg/s/cm^2',unitfrom:'ADU/s/keck_area'},nlines)
