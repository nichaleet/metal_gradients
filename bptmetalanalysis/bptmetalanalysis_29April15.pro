...
;do not take the subslit where there is only 1 pixel of h_alpha detection (a lonely island)
         meanerr,n2_inslit,n2err_inslit,wmean,sigmam,sigmad
         N2_radius(i) = wmean
...
device, filename = psname,xsize = 10,ysize = 8, $
xoffset = 0,yoffset = 0,scale_factor = 1.0,/encapsulated,/color
ploterror,radius_of_n2,m08_n2_metal,m08_n2_metal_err,xtitle='radius(kpc)',ytitle='12+log(O/H)!LM08,N2',psym=7,font=0,errcolor=200,hatlength=!D.X_VSIZE/50.
