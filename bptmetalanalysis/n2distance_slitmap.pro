...
for i=0,n_slits-1 do begin
   ...
   if pix_in_slit(0) ne -1 then begin
      ...
      thegood = where(finite(goodN2) eq 1)
      if thegood(0) ne -1 then begin
         ...
         meanerr,goodN2(thegood),goodN2err(thegood),wmean,sigmam,sigmad  ;normal weight
...
;write N2 map 
oriN2map = readfits(outdir+name+'_N2map.fits')
writefits,outdir+name+'_N2map.fits',[[[oriN2map[*,*,0]]],[[oriN2map[*,*,1]]],[[N2mapslit]]]
