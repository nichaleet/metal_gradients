...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First exposure
c1 = readfits('s140224_a021001_tlc_Hn2_100.fits')  ; "A" position
c2 = readfits('s140224_a021002_tlc_Hn2_100.fits',hdr)       ; "B" position
 ; Second exposure
c3 = readfits('s140224_a024001_tlc_Hn2_100.fits')  ; A
c4 = readfits('s140224_a024002_tlc_Hn2_100.fits')  ; B
...
writefits,'cswa20_Ha_tlc_Hn2_handmosaic_scaledsky_1hr.fits', cube_mean, hdr
