...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s130303_a010001_tlc_Hn2_100.fits',hdr)  ; "A" position  
c2 = readfits('s130303_a010002_tlc_Hn2_100.fits')       ; "B" position  
c3 = readfits('s130303_a010003_tlc_Hn2_100.fits')  ; A  
c4 = readfits('s130303_a010004_tlc_Hn2_100.fits')  ; B
  ; second night
c5 = readfits('s130304_a009001_tlc_Hn2_100.fits')  ; A  
c6 = readfits('s130304_a009002_tlc_Hn2_100.fits')  ; B  
c7 = readfits('s130304_a009003_tlc_Hn2_100.fits')  ; A  
c8 = readfits('s130304_a009004_tlc_Hn2_100.fits')  ; B  
c9 = readfits('s130304_a010001_tlc_Hn2_100.fits')  ; A  
c10 = readfits('s130304_a010002_tlc_Hn2_100.fits')  ; B
c11 = readfits('s130304_a010003_tlc_Hn2_100.fits')  ; A
c12 = readfits('s130304_a010004_tlc_Hn2_100.fits')  ; B
  ; third night
c13 = readfits('s140223_a006001_tlc_Hn2_100.fits')  ; B
c14 = readfits('s140223_a006002_tlc_Hn2_100.fits')  ; A
c15 = readfits('s140223_a006003_tlc_Hn2_100.fits')  ; B
c16 = readfits('s140223_a006004_tlc_Hn2_100.fits')  ; A
c17 = readfits('s140223_a007001_tlc_Hn2_100.fits')  ; B
c18 = readfits('s140223_a007002_tlc_Hn2_100.fits')  ; A
...
unwrap, smooth(cube_mean,[1,3,3]), 'c11_tlc_Hn2_unwrapped_crrej.fits'

writefits,'cswa11_Ha_tlc_Hn2_handmosaic_sky_430hr.fits', cube_mean, hdr
