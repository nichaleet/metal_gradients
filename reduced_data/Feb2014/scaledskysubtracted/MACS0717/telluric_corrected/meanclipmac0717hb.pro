...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s140224_a008001_tlc_Hbb_100.fits')  ; "A" position
c2 = readfits('s140224_a008002_tlc_Hbb_100.fits',hdr)       ; "B" position
c3 = readfits('s140224_a008003_tlc_Hbb_100.fits')  ; A
c4 = readfits('s140224_a008004_tlc_Hbb_100.fits')  ; B
...
unwrap, smooth(cube_mean,[1,3,3]), 'macs0717_tlc_Hbb_unwrapped_crrej.fits'

writefits,'macs0717_Hb_tlc_Hbb_handmosaic_scaledsky_1hr.fits', cube_mean, hdr
