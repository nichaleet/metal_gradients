...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s140224_a005001_tlc_Kc5_100.fits')  ; "A" position
c2 = readfits('s140224_a005002_tlc_Kc5_100.fits',hdr)       ; "B" position
c3 = readfits('s140224_a005003_tlc_Kc5_100.fits')  ; A
c4 = readfits('s140224_a005004_tlc_Kc5_100.fits')  ; B
c5 = readfits('s140224_a006001_tlc_Kc5_100.fits')  ; A
c6 = readfits('s140224_a006002_tlc_Kc5_100.fits')  ; B
...
unwrap, smooth(cube_mean,[1,3,3]), 'macs0717_tlc_kc5_unwrapped_crrej.fits'

writefits,'macs0717_Ha_tlc_Kc5_handmosaic_scaledsky_130hr.fits', cube_mean, hdr
