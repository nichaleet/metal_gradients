...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s130303_a022001_tlc_Kn1_100.fits', hdr)  ; "A" position
c2 = readfits('s130303_a022002_tlc_Kn1_100.fits')       ; "B" position

  ; Second night
c3 = readfits('s140223_a023001_tlc_Kn1_100.fits')  ; A
c4 = readfits('s140223_a023002_tlc_Kn1_100.fits')  ; B
c5 = readfits('s140223_a023003_tlc_Kn1_100.fits')  ; A
c6 = readfits('s140223_a023004_tlc_Kn1_100.fits')  ; B
  ; Wavelength scale
...
writefits,'cswa28_Ha_tlc_Kn1_handmosaic_scaledsky_130hr.fits', cube_mean, hdr
