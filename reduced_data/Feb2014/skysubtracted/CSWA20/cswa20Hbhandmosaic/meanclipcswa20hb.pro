...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First exposure
c1 = readfits('s140223_a026001_Jn1_100.fits')  ; "A" position
c2 = readfits('s140223_a026002_Jn1_100.fits',hdr)       ; "B" position
c3 = readfits('s140223_a026003_Jn1_100.fits')  ; A
...
unwrap, smooth(cube_mean,[1,3,3]), 'c20_Jn1_unwrapped_crrej.fits'

writefits,'cswa20_Hb_Jn1_handmosaic_sky_075hr.fits', cube_mean, hdr
