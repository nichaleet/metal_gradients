...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s140223_a019001_tlc_Kn2_100.fits', hdr)  ; "A" position
c2 = readfits('s140223_a019002_tlc_Kn2_100.fits')       ; "B" position
c3 = readfits('s140223_a019003_tlc_Kn2_100.fits')  ; A
c4 = readfits('s140223_a019004_tlc_Kn2_100.fits')  ; B
c5 = readfits('s140223_a020001_tlc_Kn2_100.fits')  ; A
c6 = readfits('s140223_a020002_tlc_Kn2_100.fits')  ; B
  ; Second night
c7 = readfits('s140224_a019001_tlc_Kn2_100.fits')  ; A (within ~1 pixel)
c8 = readfits('s140224_a019002_tlc_Kn2_100.fits')  ; B
c9 = readfits('s140224_a019003_tlc_Kn2_100.fits')  ; A
c10= readfits('s140224_a019004_tlc_Kn2_100.fits')  ; B
  ; Wavelength scale
...
unwrap, smooth(cube_mean,[1,3,3]), 'c15_tlc_kn2_unwrapped_crrej.fits'

writefits,'cswa15_Ha_tlc_Kn2_handmosaic_sky_230hr.fits', cube_mean, hdr
