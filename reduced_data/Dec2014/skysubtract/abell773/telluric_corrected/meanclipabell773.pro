...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
  c1 = readfits('s130303_a008001_tlc_Kc3_100.fits', hdr) ; "A" position
  c2 = readfits('s130303_a008002_tlc_Kc3_100.fits')      ; "B" position
  c3 = readfits('s130303_a008003_tlc_Kc3_100.fits')      ; "A" position
  c4 = readfits('s130303_a008004_tlc_Kc3_100.fits')      ; "B" position

  ;second night
  c5 = readfits('s140222_a006001_tlc_Kc3_100.fits')     ; "A" position
  c6 = readfits('s140222_a006002_tlc_Kc3_100.fits')     ; "B" position
  c7 = readfits('s140222_a006003_tlc_Kc3_100.fits')     ; "A" position
  c8 = readfits('s140222_a006004_tlc_Kc3_100.fits')     ; "B" position
  c9 = readfits('s140222_a007001_tlc_Kc3_100.fits')     ; "A" position
  c10 = readfits('s140222_a007002_tlc_Kc3_100.fits')    ; "B" position
...
unwrap, smooth(cube_mean,[1,3,3]), 'a773_tlc_kc3_unwrapped_crrej.fits'

writefits,'abell773_Ha_tlc_Kc3_handmosaic_sky_330hr.fits', cube_mean, hdr
