...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s141206_a020001_tlc_Jbb_100.fits', hdr)  ; "A" position
c2 = readfits('s141207_a024001_tlc_Jbb_100.fits')       ; "B" position
...
writefits,'cswa31_Hb_tlc_Jbb_handmosaic_scaledsky_030hr.fits', cube_mean, hdr
