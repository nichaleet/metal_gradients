...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s141206_a013001_Hn3_100.fits', hdr)  ; "A" position
c2 = readfits('s141206_a013002_Hn3_100.fits')       ; "B" position
c3 = readfits('s141206_a013003_Hn3_100.fits')  ; A

c4 = readfits('s141206_a015001_Hn3_100.fits')  ; B
c5 = readfits('s141206_a015002_Hn3_100.fits')  ; A

c6 = readfits('s141206_a016001_Hn3_100.fits')  ; B
c7 = readfits('s141206_a016002_Hn3_100.fits')  ; A
c8 = readfits('s141206_a016003_Hn3_100.fits')  ; B
c9 = readfits('s141206_a016004_Hn3_100.fits')  ; A

c10 = readfits('s141206_a017001_Hn3_100.fits')  ; B
c11 = readfits('s141206_a017002_Hn3_100.fits')  ; A
c12 = readfits('s141206_a017003_Hn3_100.fits')  ; B
...
writefits,'cswa31_Ha_Hn3_handmosaic_scaledsky_3hr.fits', cube_mean, hdr
