...
; Add individual reduced data cubes in such a way that cosmic rays can be rejected from each frame.
  ; First night
c1 = readfits('s130911_a021001_tlc_Kn2_100.fits', hdr)  ; "A" position
c2 = readfits('s130911_a021002_tlc_Kn2_100.fits')       ; "B" position
c3 = readfits('s130911_a021003_tlc_Kn2_100.fits')  ; A
c4 = readfits('s130911_a021004_tlc_Kn2_100.fits')  ; B
c5 = readfits('s130911_a022001_tlc_Kn2_100.fits')  ; A
c6 = readfits('s130911_a022002_tlc_Kn2_100.fits')  ; B
...
writefits,'cswa128_Ha_tlc_Kn2_handmosaic_sky_130hr.fits', cube_mean, hdr
